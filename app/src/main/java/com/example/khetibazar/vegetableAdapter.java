...
public class vegetableAdapter extends ArrayAdapter<String> {
    int [] logo;
    String[] name;
    String [] price;
    String [] farmername;
    ...
    public vegetableAdapter(Activity context1, int[] logo, String[] name, String[] price, String[] farmername ) {
